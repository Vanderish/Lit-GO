    ...
    <div className="dashboard-root">
      ...
      <main className="dashboard-container">
        <div className="wrap">
          ...
          {/* LOBBY NAVIGASI (Dengan Icon Persis Native) */}
        ...
        <div className="modal-overlay" id="modal-confirm">
          <div className="modal-box" style={{maxWidth:'420px', textAlign:'center'}}>
            ...
            <div className="modal-footer" style={{justifyContent:'center'}}>
              ...
              <button className="btn-modal-danger" onClick={() => { localStorage.removeItem('litgo_complete_v1'); window.location.reload(); }}>Ya, Reset Sekarang</button>
            </div>
          </div>
        </div>
      )}
